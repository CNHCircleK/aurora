                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                            ...
                            <div class="form-group{{ $errors->has('school') ? ' has-error' : '' }}">
                                <label for="school" class="col-md-4 control-label">School OR Division</label>
                            ...
                            <div class="form-group{{ $errors->has('invitation_code') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('invitation_code', Request::input('code'),
                                    ['id' => 'invitation-code', 'class' => 'form-control', 'required']) !!}
